...
| 4 | Обработка исключений, в. 6 | Расчет среднего арифметического, FileCopy (в. 2), кастомный Exception | [lab4/](lab4/) |
...
| 7 | Многопоточность, в. 2 | Сумма массива, поиск максимума в матрице (в. 2), барьер грузчиков, в. 2 | [lab7/](lab7/) |
